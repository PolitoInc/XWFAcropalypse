...
// Item type stuff
#define XT_ITEM_TYPE_NOT_VERIFIED 0x0
#define XT_ITEM_TYPE_TOO_SMALL 0x1
#define XT_ITEM_TYPE_TOTALLY_UNKNOWN 0x2
#define XT_ITEM_TYPE_CONFIRMED 0x3
#define XT_ITEM_TYPE_UNCONFIRMED 0x4
#define XT_ITEM_TYPE_NEWLY_IDENTIFIED 0x5
#define XT_ITEM_TYPE_MISMATCH 0x6

// Item property stuff
#define XT_PROPERTY_LOGICAL_FILE_SIZE 0x01
...
#define XWF_ITEM_INFO_FLAG_NOTABLE 0x00400000	// Flag the item as notable in the X-Ways UI
